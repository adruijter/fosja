<?php
	...
	class LoginClass
	{
		...
		private $password;// varchar (32)
		private $userrole;// enum (root, administrator, photographer, customer, developer
		private $activated; // enum (yes, no)
		private $activationdate;  //datetime
